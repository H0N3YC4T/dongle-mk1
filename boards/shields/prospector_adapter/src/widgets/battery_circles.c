...
static void update_peripheral_display(uint8_t source) {
    ...
    lv_style_t *ring_style = !connected ? &style_arc_ring_disconnected :
                             low_battery ? &style_arc_ring_low :
                             mid_battery ? &style_arc_ring_mid : &style_arc_ring_connected;
    lv_style_t *ind_style = !connected ? &style_arc_ind_disconnected :
                            low_battery ? &style_arc_ind_low :
                            mid_battery ? &style_arc_ind_mid : &style_arc_ind_connected;
    lv_style_t *box_style = !connected ? &style_label_box_disconnected :
                            low_battery ? &style_label_box_low :
                            mid_battery ? &style_label_box_mid : &style_label_box_connected;
