...
static const struct page_cell clipboard_cells[] = {
    {0, 0, 1, 1, "UNDO",              NULL, THEME_PRIMARY, ACT_SEND_KEY, .arg.keycode = LC(Z)},
    {0, 1, 1, 1, NULL,        &icon_up, THEME_DENY,     ACT_GO_VIEW,  .arg.view = &view_home},
    {0, 2, 1, 1, "REDO",              NULL, THEME_PRIMARY, ACT_SEND_KEY, .arg.keycode = LC(Y)},
    ...
    {2, 1, 1, 1, NULL,  &icon_newline, THEME_SECONDARY,  ACT_SEND_KEY, .arg.keycode = RETURN},
