...
static const struct page_cell sym_p1[] = {
    ...
    {0, 2, 1, 1, "?", NULL, THEME_SECONDARY, ACT_SEND_KEY, .arg.keycode = LPAR},
...
static const struct page_cell sym_p2[] = {
    ...
    {1, 2, 1, 1, "}", NULL, THEME_SECONDARY, ACT_SEND_KEY, .arg.keycode = BSLH},
...
static const struct page_cell sym_p3[] = {
    {0, 0, 1, 1, "<", NULL, THEME_SECONDARY, ACT_SEND_KEY, .arg.keycode = COLON},
    {0, 1, 1, 1, NULL, &icon_up, THEME_FOCUS, ACT_PREV_PAGE},
    {0, 2, 1, 1, ">", NULL, THEME_SECONDARY, ACT_SEND_KEY, .arg.keycode = SQT},

    {1, 0, 1, 1, "\"", NULL, THEME_PRIMARY, ACT_SEND_KEY, .arg.keycode = DQT},
    {1, 1, 1, 1, "'", NULL, THEME_SECONDARY, ACT_SEND_KEY, .arg.keycode = COMMA},
    {1, 2, 1, 1, "`", NULL, THEME_PRIMARY, ACT_SEND_KEY, .arg.keycode = DOT},

    {2, 0, 1, 1, ",", NULL, THEME_SECONDARY, ACT_SEND_KEY, .arg.keycode = LT},
    {2, 1, 1, 1, NULL, &icon_down, THEME_FOCUS, ACT_NEXT_PAGE},
    {2, 2, 1, 1, ".", NULL, THEME_SECONDARY, ACT_SEND_KEY, .arg.keycode = GT},
    {0}};
