...
static const struct page_cell sym_p0[] = {
    ...
    {1, 0, 1, 1, "#", NULL, THEME_PRIMARY, ACT_SEND_KEY, .arg.keycode = HASH},
    {1, 1, 1, 1, "$", NULL, THEME_PRIMARY, ACT_SEND_KEY, .arg.keycode = DLLR},
    {1, 2, 1, 1, "%", NULL, THEME_PRIMARY, ACT_SEND_KEY, .arg.keycode = PRCNT},
...
static const struct page_cell sym_p1[] = {
    ...
    {0, 2, 1, 1, "(", NULL, THEME_PRIMARY, ACT_SEND_KEY, .arg.keycode = LPAR},
    {1, 0, 1, 1, ")", NULL, THEME_PRIMARY, ACT_SEND_KEY, .arg.keycode = RPAR},
    {1, 1, 1, 1, "-", NULL, THEME_PRIMARY, ACT_SEND_KEY, .arg.keycode = MINUS},
...
static const struct page_cell sym_p2[] = {
    ...
    {1, 0, 1, 1, "{", NULL, THEME_PRIMARY, ACT_SEND_KEY, .arg.keycode = LBRC},
    {1, 1, 1, 1, "}", NULL, THEME_PRIMARY, ACT_SEND_KEY, .arg.keycode = RBRC},
    {1, 2, 1, 1, "\\", NULL, THEME_PRIMARY, ACT_SEND_KEY, .arg.keycode = BSLH},
...
static const struct page_cell sym_p3[] = {
    ...
    {0, 1, 1, 1, NULL, &icon_up, THEME_FOCUS, ACT_PREV_PAGE},
    {0, 2, 1, 1, "'", NULL, THEME_PRIMARY, ACT_SEND_KEY, .arg.keycode = SQT},
    {1, 0, 1, 1, "\"", NULL, THEME_PRIMARY, ACT_SEND_KEY, .arg.keycode = DQT},
    {1, 1, 1, 1, ",", NULL, THEME_PRIMARY, ACT_SEND_KEY, .arg.keycode = COMMA},
    {1, 2, 1, 1, ".", NULL, THEME_PRIMARY, ACT_SEND_KEY, .arg.keycode = DOT},
