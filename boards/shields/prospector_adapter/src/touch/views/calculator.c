...
static const struct page_cell calc_cells[] = {
    ...
    {1, 0, 1, 1, "7", NULL, THEME_PRIMARY, ACT_CUSTOM_VAL, .arg.custom = {tap_calc_char, '7'}},
    {1, 1, 1, 1, "8", NULL, THEME_PRIMARY, ACT_CUSTOM_VAL, .arg.custom = {tap_calc_char, '8'}},
    {1, 2, 1, 1, "9", NULL, THEME_PRIMARY, ACT_CUSTOM_VAL, .arg.custom = {tap_calc_char, '9'}},
    {1, 3, 1, 1, "+", NULL, THEME_SECONDARY, ACT_CUSTOM_VAL, .arg.custom = {tap_calc_char, '+'}},

    {2, 0, 1, 1, "4", NULL, THEME_PRIMARY, ACT_CUSTOM_VAL, .arg.custom = {tap_calc_char, '4'}},
    {2, 1, 1, 1, "5", NULL, THEME_PRIMARY, ACT_CUSTOM_VAL, .arg.custom = {tap_calc_char, '5'}},
    {2, 2, 1, 1, "6", NULL, THEME_PRIMARY, ACT_CUSTOM_VAL, .arg.custom = {tap_calc_char, '6'}},
    {2, 3, 1, 1, "-", NULL, THEME_SECONDARY, ACT_CUSTOM_VAL, .arg.custom = {tap_calc_char, '-'}},

    {3, 0, 1, 1, "1", NULL, THEME_PRIMARY, ACT_CUSTOM_VAL, .arg.custom = {tap_calc_char, '1'}},
    {3, 1, 1, 1, "2", NULL, THEME_PRIMARY, ACT_CUSTOM_VAL, .arg.custom = {tap_calc_char, '2'}},
...
static const struct page_cell calc_cells_alt[] = {
    ...
    {1, 1, 1, 1, "8", NULL, THEME_PRIMARY, ACT_CUSTOM_VAL, .arg.custom = {tap_calc_char, '8'}},
    {1, 2, 1, 1, "9", NULL, THEME_PRIMARY, ACT_CUSTOM_VAL, .arg.custom = {tap_calc_char, '9'}},
    {1, 3, 1, 1, "()", NULL, THEME_SECONDARY, ACT_CUSTOM, .arg.func = tap_calc_bracket},

    {2, 0, 1, 1, "4", NULL, THEME_PRIMARY, ACT_CUSTOM_VAL, .arg.custom = {tap_calc_char, '4'}},
    {2, 1, 1, 1, "5", NULL, THEME_PRIMARY, ACT_CUSTOM_VAL, .arg.custom = {tap_calc_char, '5'}},
    {2, 2, 1, 1, "6", NULL, THEME_PRIMARY, ACT_CUSTOM_VAL, .arg.custom = {tap_calc_char, '6'}},
    {2, 3, 1, 1, "%", NULL, THEME_SECONDARY, ACT_CUSTOM, .arg.func = tap_calc_percent},
...
static const struct page_cell calc_cells_alt2[] = {
    ...
    {1, 2, 1, 1, "*", NULL, THEME_SECONDARY, ACT_CUSTOM_VAL, .arg.custom = {tap_calc_char, '*'}},
    {1, 3, 1, 1, "/", NULL, THEME_SECONDARY, ACT_CUSTOM_VAL, .arg.custom = {tap_calc_char, '/'}},

    {2, 0, 1, 1, "<<", NULL, THEME_SECONDARY, ACT_CUSTOM_VAL, .arg.custom = {tap_calc_shift, '<'}},
    {2, 1, 1, 1, "0", NULL, THEME_PRIMARY, ACT_CUSTOM_VAL, .arg.custom = {tap_calc_char, '0'}},
    {2, 2, 1, 1, "1", NULL, THEME_PRIMARY, ACT_CUSTOM_VAL, .arg.custom = {tap_calc_char, '1'}},
    {2, 3, 1, 1, ">>", NULL, THEME_SECONDARY, ACT_CUSTOM_VAL, .arg.custom = {tap_calc_shift, '>'}},

    {3, 0, 1, 1, "&", NULL, THEME_SECONDARY, ACT_CUSTOM_VAL, .arg.custom = {tap_calc_char, '&'}},
    {3, 1, 1, 1, "|", NULL, THEME_SECONDARY, ACT_CUSTOM_VAL, .arg.custom = {tap_calc_char, '|'}},
