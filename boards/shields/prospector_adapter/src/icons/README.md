...
| File | Descriptor variable | HOME cell (fallback) |
| --- | --- | --- |
| `icon_trackpad.c` | `icon_trackpad` | 5 (GPS-cursor glyph) |
| `icon_modkeys.c` | `icon_modkeys` | 6 ("MOD") |
| `icon_numpad.c` | `icon_numpad` | 2 ("123") |
| `icon_symbols.c` | `icon_symbols` | 3 ("#$%") |
