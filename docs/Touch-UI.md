...
HOME cell 7 (keyboard icon, greyed) is unbound — reserved for a future programmable pad.

## What each screen does

| Screen | Grid | Cells |
| --- | --- | --- |
| HOME | 3x3 | 0 = Fn · 1 = back · 2 = 123 · 3 = #$% · 4 = settings · 5 = trackpad · 6 = MOD · 7 = reserved (greyed keyboard icon, no-op) · 8 = media |
